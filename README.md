...
---------
 ...
 - [ASE 18--An Automated Approach to Estimating Code Coverage Measures via Execution Logs](./paper/twoYears/ASE_18_An_automated_approach_to_estimating_code_coverage_measures_via_execution_logs.pdf)
